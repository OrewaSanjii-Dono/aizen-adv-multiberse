...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7747828485:AAF8oXoJ4b3NbEA-mFkP6lKBhULG4PzW1Gw")
...
#Database --⚠️ REQUIRED--
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://sagatobots00001:sagatobots100@cluster00001.vgdshkw.mongodb.net/?retryWrites=true&w=majority&appName=aizen_file_store_bot")
DB_NAME = os.environ.get("DATABASE_NAME", "aizen_file_store_bot")

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#Collection of pics for Bot // #Optional but atleast one pic link should be replaced if you don't want predefined links
PICS = (os.environ.get("PICS", "https://i.postimg.cc/GpmBL6g3/5f9cec07163f9be0b14d4a4b3a14d0a5.jpg")).split() #Required
